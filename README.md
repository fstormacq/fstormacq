...
Curious about energy measurement, technology integration, and homelabbing.
...
🔗 [Explore the project](https://github.com/green-code-initiative/EnergyTracer)
...
`Raspberry Pi` `Tailscale` `SSH` `Docker`


## 📸 Outside the terminal

Photography: I also shoot things outside of pull requests
